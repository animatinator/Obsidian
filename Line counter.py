...
excluded = ["constants.py", "gravity.py", "interpolate.py", "keyframes.py", "Keyframe selector widget testery.py", "Line counter.py", "obstacles.py", "particles.py", "PyIgnition.py", "xml.py"]
